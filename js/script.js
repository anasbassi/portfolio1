...
const projectsData = [
  ...
  },
  {
    ...
    description:
      'Pokémon Cards Collection project is an application for displaying the first 20 pokemon, details of a specific Pokémon can be seen by clicking on a pokemon card, a pokemon card can also be stared or commented on.',
    imageUrl: [
